  ...
  const res = (props) => {
    ...
    return (
            <Suspense fallback={<PreloadFallback/>}>
                {
                    childrenWithProps(dimensions, <Component {...props}/>)
                }
            </Suspense>
    );
  };
...
const HomeCareHome = initLazy(() => import('../screens/home_care_home/HomeCareHome'));
...
const MedServPostInfScreen = initLazy(() => import('../screens/home_care_home/MedServPostInfScreen'));
const DoctorListScreen = initLazy(() => import('../screens/doctor_list/DoctorListScreen'));
const RequestServiceListScreen = initLazy(() => import('../screens/request_service_list/RequestServiceListScreen'));
...
const AttendanceScreen = initLazy(() => import('../screens/attendance_screen/AttendanceScreen'));
const QueueListScreen = initLazy(() => import('../screens/queue_list/QueueListScreen'), true);
const AttendancePostInfScreen = initLazy(() => import('../screens/attendance_screen/AttendancePostInfScreen'));
const AttendanceHistoryScreen = initLazy(() => import('../screens/attendance_history/AttendanceHistoryScreen'));
const AttendanceReceipt = initLazy(() => import('../screens/attendance_screen/AttendanceReceipt'));
        ...
        <Stack.Navigator
            ...
            <Stack.Screen name="payment-done" component={PaymentDoneScreen} />
          {
            authorization &&
              ...
              <Stack.Screen name="HomeCareHome" component={HomeCareHome} />
              ...
              <Stack.Screen name="MedServPostInfScreen" component={MedServPostInfScreen} />
              <Stack.Screen name="DoctorListScreen" component={DoctorListScreen} />
              <Stack.Screen name="RequestServiceListScreen" component={RequestServiceListScreen} />
              ...
              <Stack.Screen name="AttendancePostInfScreen" component={AttendancePostInfScreen} />
              <Stack.Screen name="AttendanceReceipt" component={AttendanceReceipt} />
              <Stack.Screen name="AttendanceHistoryScreen" component={AttendanceHistoryScreen} />
